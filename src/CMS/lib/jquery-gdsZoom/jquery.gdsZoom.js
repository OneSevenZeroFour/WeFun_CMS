;(function($){
	$.fn.gdsZoom = function(options){
		...
		this.each(function(){
			...
			var $bigImg = $('<img/>').attr('src',$smallImg.data('big')).css({'width':1200,'height':1200,'z-index':999});
			...
			if(opt.position === 'right'){
				btop =0; //$small.offset().top;
				bleft = $small.offset().left + $small.outerWidth() + opt.gap-30;
